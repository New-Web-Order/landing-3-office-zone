  ...
  return (
    <section className='w-full max-w-screen-xl flex flex-col items-center py-10 lg:py-24 gap-y-16 px-4 md:px-8 2xl:px-0 ' aria-label='Meet Our Team ' id='team'>
      <div className='w-full flex flex-col items-center gap-6 lg:gap-6'>
        <h1 className='font-bold text-3xl md:text-4xl lg:text-6xl text-fg-text-contrast text-center '>{Data.teamSection.mainHeading}</h1>
        <p className='font-normal lg:font-semibold text-base md:text-lg lg:text-xl text-fg-text text-center lg:max-w-full'>{Data.teamSection.mainText}</p>
      </div>
